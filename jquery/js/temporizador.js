(function ($) {
    $.fn.temporizador = function (opcoes) {
        ...
        const separadorHora = $('<pan class="separador">').html(':')
        const separadorMinuto = $('<pan class="separador">').html(':')
        const mensagem = $('<pan class="mensagem">').html(opcoesFinais.mensagem)
